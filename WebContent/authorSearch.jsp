...
body {
	font: 12px/180% Arial, Helvetica, sans-serif, "æ°å®ä½";
...
<body>
	...
	<table align="center" width="300" border="1" id="b1">
		<tr>
			<td align="center" colspan="6">
				<h2>
					<s:property value="name" /><%="'s all books"%></h2>
			</td>
		</tr>
		<s:iterator value="books" status="st">
			<tr align="center">
				<td><a
					href="<s:url action="bookInfo">
				<s:param name="name" value="ISBN"/></s:url>">
