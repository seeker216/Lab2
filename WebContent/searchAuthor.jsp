...
<body>
	...
	<form action="searchAuthor" method="post" onsubmit="return check(this);">
		<label for=name>Please input the author's name:</label><br> <input
			type="text" name="name" /> <input type="submit" value="Search" /><br>
	</form>
</body>
</html>